...
// NewPutConversionParams creates a new PutConversionParams object
//
// There are no default values defined in the spec.
func NewPutConversionParams() PutConversionParams {

	return PutConversionParams{}
}

// PutConversionParams contains all the bound params for the put conversion operation
// typically these are obtained from a http.Request
//
// swagger:parameters PutConversion
type PutConversionParams struct {
...
//
// To ensure default values, the struct must have been initialized with NewPutConversionParams() beforehand.
func (o *PutConversionParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *PutConversionParams) bindFromUnit(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *PutConversionParams) validateFromUnit(formats strfmt.Registry) error {
...
func (o *PutConversionParams) bindToUnit(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *PutConversionParams) validateToUnit(formats strfmt.Registry) error {
