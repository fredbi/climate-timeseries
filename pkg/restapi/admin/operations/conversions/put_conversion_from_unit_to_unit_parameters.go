...
// NewPutConversionFromUnitToUnitParams creates a new PutConversionFromUnitToUnitParams object
//
// There are no default values defined in the spec.
func NewPutConversionFromUnitToUnitParams() PutConversionFromUnitToUnitParams {

	return PutConversionFromUnitToUnitParams{}
}

// PutConversionFromUnitToUnitParams contains all the bound params for the put conversion from unit to unit operation
// typically these are obtained from a http.Request
//
// swagger:parameters PutConversionFromUnitToUnit
type PutConversionFromUnitToUnitParams struct {
...
//
// To ensure default values, the struct must have been initialized with NewPutConversionFromUnitToUnitParams() beforehand.
func (o *PutConversionFromUnitToUnitParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *PutConversionFromUnitToUnitParams) bindFromUnit(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *PutConversionFromUnitToUnitParams) validateFromUnit(formats strfmt.Registry) error {
...
func (o *PutConversionFromUnitToUnitParams) bindToUnit(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PutConversionFromUnitToUnitParams) validateToUnit(formats strfmt.Registry) error {
