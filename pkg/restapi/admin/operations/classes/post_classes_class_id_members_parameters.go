...
// PostClassesClassIDMembersParams contains all the bound params for the post classes class ID members operation
// typically these are obtained from a http.Request
//
// swagger:parameters PostClassesClassIDMembers
...
//
// To ensure default values, the struct must have been initialized with NewPostClassesClassIDMembersParams() beforehand.
func (o *PostClassesClassIDMembersParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *PostClassesClassIDMembersParams) bindClassID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *PostClassesClassIDMembersParams) validateClassID(formats strfmt.Registry) error {
