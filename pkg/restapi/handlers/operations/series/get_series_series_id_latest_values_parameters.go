...
// GetSeriesSeriesIDLatestValuesParams contains all the bound params for the get series series ID latest values operation
// typically these are obtained from a http.Request
//
// swagger:parameters GetSeriesSeriesIDLatestValues
...
//
// To ensure default values, the struct must have been initialized with NewGetSeriesSeriesIDLatestValuesParams() beforehand.
func (o *GetSeriesSeriesIDLatestValuesParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetSeriesSeriesIDLatestValuesParams) bindConvert(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetSeriesSeriesIDLatestValuesParams) validateConvert(formats strfmt.Registry) error {
...
func (o *GetSeriesSeriesIDLatestValuesParams) bindFrom(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetSeriesSeriesIDLatestValuesParams) validateFrom(formats strfmt.Registry) error {
...
func (o *GetSeriesSeriesIDLatestValuesParams) bindSeriesID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetSeriesSeriesIDLatestValuesParams) bindTo(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetSeriesSeriesIDLatestValuesParams) validateTo(formats strfmt.Registry) error {
