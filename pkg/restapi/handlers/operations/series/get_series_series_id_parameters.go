...
// GetSeriesSeriesIDParams contains all the bound params for the get series series ID operation
// typically these are obtained from a http.Request
//
// swagger:parameters GetSeriesSeriesID
...
//
// To ensure default values, the struct must have been initialized with NewGetSeriesSeriesIDParams() beforehand.
func (o *GetSeriesSeriesIDParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetSeriesSeriesIDParams) bindAudit(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetSeriesSeriesIDParams) bindBrief(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetSeriesSeriesIDParams) bindDeep(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetSeriesSeriesIDParams) bindGlob(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetSeriesSeriesIDParams) validateGlob(formats strfmt.Registry) error {
...
func (o *GetSeriesSeriesIDParams) bindSeriesID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetSeriesSeriesIDParams) bindStatus(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetSeriesSeriesIDParams) validateStatus(formats strfmt.Registry) error {
