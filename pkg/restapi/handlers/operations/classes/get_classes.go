...
type GetClassesHandlerFunc func(GetClassesParams) GetClassesResponder

// Handle executing the request and returning a response
func (fn GetClassesHandlerFunc) Handle(params GetClassesParams) GetClassesResponder {
	return fn(params)
}

// GetClassesHandler interface for that can handle valid get classes params
type GetClassesHandler interface {
	Handle(GetClassesParams) GetClassesResponder
}
