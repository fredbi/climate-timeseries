...
// PutClassesClassIDMembersClassMemberIDParams contains all the bound params for the put classes class ID members class member ID operation
// typically these are obtained from a http.Request
//
// swagger:parameters PutClassesClassIDMembersClassMemberID
...
//
// To ensure default values, the struct must have been initialized with NewPutClassesClassIDMembersClassMemberIDParams() beforehand.
func (o *PutClassesClassIDMembersClassMemberIDParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *PutClassesClassIDMembersClassMemberIDParams) bindClassID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *PutClassesClassIDMembersClassMemberIDParams) validateClassID(formats strfmt.Registry) error {
...
func (o *PutClassesClassIDMembersClassMemberIDParams) bindClassMemberID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
