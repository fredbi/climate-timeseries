...
// PutConversionsFromUnitToUnitParams contains all the bound params for the put conversions from unit to unit operation
// typically these are obtained from a http.Request
//
// swagger:parameters PutConversionsFromUnitToUnit
...
//
// To ensure default values, the struct must have been initialized with NewPutConversionsFromUnitToUnitParams() beforehand.
func (o *PutConversionsFromUnitToUnitParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *PutConversionsFromUnitToUnitParams) bindFromUnit(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *PutConversionsFromUnitToUnitParams) validateFromUnit(formats strfmt.Registry) error {
...
func (o *PutConversionsFromUnitToUnitParams) bindToUnit(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PutConversionsFromUnitToUnitParams) validateToUnit(formats strfmt.Registry) error {
