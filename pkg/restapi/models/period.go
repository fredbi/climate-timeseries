...
func (m *Period) ShortCode() ClassNomenclatureName {
	return "period"
}

// SetShortCode sets the short code of this subtype
func (m *Period) SetShortCode(val ClassNomenclatureName) {
}
...
func (m *Period) contextValidateShortCode(ctx context.Context, formats strfmt.Registry) error {
