...
func (m *Owner) ShortCode() ClassNomenclatureName {
	return "owner"
}

// SetShortCode sets the short code of this subtype
func (m *Owner) SetShortCode(val ClassNomenclatureName) {
}
...
func (m *Owner) contextValidateShortCode(ctx context.Context, formats strfmt.Registry) error {
