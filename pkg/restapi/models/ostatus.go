...
// Ostatus Status of owners.
//
//
// swagger:model ostatus
type Ostatus struct {
...
func (m Ostatus) MarshalJSON() ([]byte, error) {
	var b1, b2, b3 []byte
	var err error
...
// Validate validates this ostatus
func (m *Ostatus) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *Ostatus) validateAuditTrail(formats strfmt.Registry) error {
...
func (m *Ostatus) validateDescriptionLong(formats strfmt.Registry) error {
...
func (m *Ostatus) validateDescriptionShort(formats strfmt.Registry) error {
...
func (m *Ostatus) validateID(formats strfmt.Registry) error {
...
func (m *Ostatus) validateTitle(formats strfmt.Registry) error {
...
// ContextValidate validate this ostatus based on the context it is used
func (m *Ostatus) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *Ostatus) contextValidateAuditTrail(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Ostatus) contextValidateDescriptionLong(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Ostatus) contextValidateDescriptionShort(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Ostatus) contextValidateID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Ostatus) contextValidateShortCode(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Ostatus) contextValidateTitle(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Ostatus) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *Ostatus) UnmarshalBinary(b []byte) error {
	var res Ostatus
