...
// Ztype Typology of geographical zones (e.g. world, country, ...)
//
//
// swagger:model ztype
type Ztype struct {
...
func (m Ztype) MarshalJSON() ([]byte, error) {
	var b1, b2, b3 []byte
	var err error
...
// Validate validates this ztype
func (m *Ztype) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *Ztype) validateAuditTrail(formats strfmt.Registry) error {
...
func (m *Ztype) validateDescriptionLong(formats strfmt.Registry) error {
...
func (m *Ztype) validateDescriptionShort(formats strfmt.Registry) error {
...
func (m *Ztype) validateID(formats strfmt.Registry) error {
...
func (m *Ztype) validateTitle(formats strfmt.Registry) error {
...
// ContextValidate validate this ztype based on the context it is used
func (m *Ztype) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *Ztype) contextValidateAuditTrail(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Ztype) contextValidateDescriptionLong(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Ztype) contextValidateDescriptionShort(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Ztype) contextValidateID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Ztype) contextValidateShortCode(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Ztype) contextValidateTitle(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Ztype) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *Ztype) UnmarshalBinary(b []byte) error {
	var res Ztype
