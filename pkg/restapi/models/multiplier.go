...
func (m *Multiplier) ShortCode() ClassNomenclatureName {
	return "multiplier"
}

// SetShortCode sets the short code of this subtype
func (m *Multiplier) SetShortCode(val ClassNomenclatureName) {
}
...
func (m *Multiplier) contextValidateShortCode(ctx context.Context, formats strfmt.Registry) error {
