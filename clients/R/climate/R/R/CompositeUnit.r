...
#' @export
CompositeUnit <- R6::R6Class(
  'CompositeUnit',
  public = list(
    initialize = function(){
    },
    toJSON = function() {
      CompositeUnitObject <- list()

      CompositeUnitObject
    },
    fromJSON = function(CompositeUnitJson) {
      CompositeUnitObject <- jsonlite::fromJSON(CompositeUnitJson)
    },
    ...
    fromJSONString = function(CompositeUnitJson) {
      CompositeUnitObject <- jsonlite::fromJSON(CompositeUnitJson)
    }
  )
)
