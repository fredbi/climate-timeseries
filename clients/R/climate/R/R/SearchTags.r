...
#' @export
SearchTags <- R6::R6Class(
  'SearchTags',
  public = list(
    initialize = function(){
    },
    toJSON = function() {
      SearchTagsObject <- list()

      SearchTagsObject
    },
    fromJSON = function(SearchTagsJson) {
      SearchTagsObject <- jsonlite::fromJSON(SearchTagsJson)
    },
    ...
    fromJSONString = function(SearchTagsJson) {
      SearchTagsObject <- jsonlite::fromJSON(SearchTagsJson)
    }
  )
)
