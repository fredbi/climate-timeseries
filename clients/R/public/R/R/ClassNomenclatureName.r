...
#' ClassNomenclatureName Class
#'
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
ClassNomenclatureName <- R6::R6Class(
  'ClassNomenclatureName',
  public = list(
    initialize = function(){
    },
    toJSON = function() {
      ClassNomenclatureNameObject <- list()

      ClassNomenclatureNameObject
    },
    fromJSON = function(ClassNomenclatureNameJson) {
      ClassNomenclatureNameObject <- jsonlite::fromJSON(ClassNomenclatureNameJson)
    },
    ...
    fromJSONString = function(ClassNomenclatureNameJson) {
      ClassNomenclatureNameObject <- jsonlite::fromJSON(ClassNomenclatureNameJson)
    }
  )
)
