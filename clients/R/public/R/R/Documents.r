...
#' @export
Documents <- R6::R6Class(
  'Documents',
  public = list(
    initialize = function(){
    },
    toJSON = function() {
      DocumentsObject <- list()

      DocumentsObject
    },
    fromJSON = function(DocumentsJson) {
      DocumentsObject <- jsonlite::fromJSON(DocumentsJson)
    },
    ...
    fromJSONString = function(DocumentsJson) {
      DocumentsObject <- jsonlite::fromJSON(DocumentsJson)
    }
  )
)
